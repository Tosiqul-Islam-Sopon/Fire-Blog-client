    ...
    const linksSm = <>
        ...
        <li><NavLink to={`/wishlist`}>Wishlist</NavLink></li>
        {
            user ? <>
                ...
                :
                <>
                    <li><NavLink to="/register"><a className="">Register</a></NavLink></li>
                    <li><NavLink to="/login"><a className="">Login</a></NavLink></li>
                </>
        }
    </>
        ...
        <div className="navbar bg-[#101820] text-[#FBEAEB]">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-[#101820] rounded-box w-52">
                        {linksSm}
                    </ul>
                </div>
